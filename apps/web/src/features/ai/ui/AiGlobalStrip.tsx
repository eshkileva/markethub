...
export function AiGlobalStrip() {
  ...
  return (
    <div className="border-primary/20 from-primary/10 via-primary/5 relative hidden shrink-0 overflow-hidden border-b bg-gradient-to-r to-transparent px-3 py-2 sm:block lg:px-6">
